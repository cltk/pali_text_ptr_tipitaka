function refreshit()
{
	document.getElementById('mafb').innerHTML='<div style="color:'+colorcfg['coltext']+'" id = "c" align=center><h1>Welcome to the Digital Pali Reader v'+version+'</h1><p>To start, simply choose a book, section and passage on the right side of the screen.</b></p><p>If you encounter any problems, simply press the "*" button to restart the reader.</b></p><p>For detailed instructions, click on the "?" button for the help page.</p<p>For information on updates, visit <b><a href="http://www.sourceforge.net/projects/digitalpali" target="_blank">the project site</a></b>.</b></p><p>If you have questions or feedback, you can try to contact me at <b><a href="mailto:yuttadhammo@gmail.com">yuttadhammo@gmail.com</a></b></p></div><div id="mafd" align=center></div><div id="mafe" align=center></div>';
	if (remote) {
	...
	document.getElementById('difb').innerHTML = '<h3 style="color:'+colorcfg['coltext']+'">Quote of the Moment:</h3><p valign=middle>' + dbv[rverse] + '</p>';
}
